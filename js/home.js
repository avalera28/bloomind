...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const colorSecondary = getComputedStyle(document.body).getPropertyValue("--color-secondary");
    ...
    ScrollTrigger.create({
        ...
        onToggle: (self) => {
            ...
            gsap.to(".header, .mobile-menu", { "background-color": colorBackground, duration: 0.3 });
            gsap.to(".hamburger-menu", { "color": colorPrimary, duration: 0.3 });
            animateLogo();
        ...
        onLeaveBack: ({ progress, direction, isActive }) => {
            ...
            gsap.to(".header, .mobile-menu", { "background-color": colorPrimary, duration: 0.3 })
            gsap.to(".hamburger-menu", { "color": colorSecondary, duration: 0.3 });
